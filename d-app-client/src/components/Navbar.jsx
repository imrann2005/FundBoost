...
function handleChange(e) {
  ...
  return (
    ...
    <div id='nav-search' className=' w-[70%] bg-[#f3f3f3] h-8 rounded-md flex items-center justify-around'>
      ...
      <div id='search-icon' className='h-[100%] w-10 bg-[#2181F8] border-[#FFFFF]'>
    ...
    <ul className='flex'>
      ...
      <li><IconButton aria-label='Connect to wallet' size='large' title='Create Fundraising' aria-labelledby='Wallet'>
        <AddBusinessIcon  sx={{
          color : "#f3f3f3"
